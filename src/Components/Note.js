  ...
  return (
    <div>
          <form onSubmit={handleSubmit} className='flex sm:w-full md:w-2/5 h-13 m-auto '>
              <input type={'text'} className='border-b-2 focus:outline-sky-300 focus:border-none rounded-sm border-slate-700 mt-5 w-4/5 px-4 py-2 placeholder:text-left placeholder:font-light placeholder:text-lg text-lg font-light' placeholder='What is your focus for today?' onChange={handleChange} value={text}></input>
